---
title: 'The Return of the Renaissance Generalist'
date: 2026-05-09
excerpt: "As AI reshapes work, education and the skills society values, the old question of what to learn becomes harder to answer. The future may not belong only to specialists, but to people who can learn broadly, transfer ideas and develop a full range of human intelligences: creative, linguistic, embodied, analytical and relational."
thumbnail: "blogs/images/renaissance/leonardo.jpg"
short_title: 'What Should We Learn?'
permalink: /fablogio/generalist/
hidden: false
---
...
<figure class="collab-figure" style="max-width: 500px; margin: 20px auto;">
  <img src="images/renaissance/alva_old.png" alt="Skate" style="width: 100%; border-radius: 8px; display: block;">
...
<figure class="collab-figure" style="max-width: 500px; margin: 20px auto;">
  <img src="images/renaissance/surfing1.JPG" alt="surf" style="width: 100%; border-radius: 8px; display: block;">
...
<figure class="collab-figure" style="max-width: 500px; margin: 20px auto;">
  <img src="images/renaissance/cat_latte_art.jpg" alt="coffee" style="width: 100%; border-radius: 8px; display: block;">
...
<figure class="collab-figure" style="max-width: 500px; margin: 20px auto;">
  <img src="images/renaissance/leonardo.jpg" alt="The renaissance Man -" style="width: 100%; border-radius: 8px; display: block;">
