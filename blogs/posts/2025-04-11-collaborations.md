...
date: 2026-04-11
excerpt: "Part 3 of the PhD survival series. Most meaningful work is done in teams. Collaboration is a multiplier, but only when scale, structure, and ownership are designed well."
thumbnail: "blogs/images/idiap/justiceLeagueNVIB.png"
short_title: 'Collaborations'
permalink: /fablogio/collaborations/
hidden: true
---

**TL;DR** The most meaningful work I did was not done alone. Collaboration is a multiplier, but only when teams are designed well. Small teams with clear ownership move fast and go deep. As teams grow, structure and hierarchy become necessary or coordination becomes the bottleneck. The most effective teams balance rigour, engineering, and trust, and the ones that matter most are often driven by curiosity and genuine enjoyment rather than output metrics.
...
---
title: 'PhD Survival Series: Collaborations'
date: 2026-04-11
excerpt: "Part 3 of the PhD survival series. Most meaningful work is done in teams. Collaboration is a multiplier, but only when scale, structure, and ownership are designed well."
thumbnail: "blogs/images/idiap/justiceLeagueNVIB.png"
short_title: 'PhD Survival Series: Collaborations'
permalink: /fablogio/collaborations/
---

**TL;DR** Most meaningful work is not done alone. Collaboration is a multiplier, but only when teams are designed well. Small teams with clear ownership move fast and go deep. As teams grow, structure and hierarchy become necessary or coordination becomes the bottleneck. The most effective teams balance rigour, engineering, and trust, and the ones that matter most are often driven by curiosity and genuine enjoyment rather than output metrics.

### Takeaways

**Most meaningful work is not done alone.** A PhD may be framed as an individual pursuit, but the parts that compound are often collaborative. The same patterns show up anywhere people build things together, research labs, startups, even small project teams. Collaboration does not work by accident; it requires clear ownership, shared incentives, and deliberate design.

Small teams thrive on trust, complementary strengths, and a genuine “yes, and” energy. They move fast because communication is simple and ownership is clear. As teams grow, that breaks down. Structure must grow with them, or coordination becomes the bottleneck. This is less about research, and more about how teams work.

In the end, the collaborations that mattered most were not the most optimised, but the most energising. Curiosity, trust, and a sense of shared purpose carried them further than metrics ever did.
